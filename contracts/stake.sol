...
contract StakingToken is ERC20 {
    ...
    constructor(uint256 initialSupply, address _stakingToken, address _rewardToken) ERC20("reward", "RWRD") {
   ...
   function stake(uint256 _stake) public {
        ...
        if(userMap[msg.sender].isStakeholder == false) {
   ...
   function claimReward() public {
        ...
        //---------------for added value in stake if there is
        userMap[msg.sender].rewards = calculateReward(msg.sender);
        userMap[msg.sender].stakeStartTime = block.timestamp;
   }
}
